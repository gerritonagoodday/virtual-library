<?php
// $Id: BibTex.php 89 2009-09-08 17:23:19Z gerrit_hoekstra $
  /* vim: set ts=4 sw=4: */
  /**
   ...
   * @version    CVS: $Id: BibTex.php 89 2009-09-08 17:23:19Z gerrit_hoekstra $
   * @link       http://pear.php.net/package/Structures_BibTex
   *
   * Changes:
   * 20060913   Added 'patent' publication type
   *            Gerrit Hoekstra www.hoekstra.co.uk
   */
...
function html()
    {
        $ret = "<table border='0' padding='1px' class='prettytable'>";
        foreach ($this->data as $entry) {
