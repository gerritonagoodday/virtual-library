<?php
// $Id: germani.messages.php 88 2009-09-08 17:21:03Z gerrit_hoekstra $
...
define("VL_EDT_NAME_SHORTAUTHNAMES","Verkürzte Autornamen");
...
define("VL_EDT_DESC_ADDRESS","Verlagadresse in einer eizelnen Zeile");
define("VL_EDT_DESC_ANNOTE","Anmerkung zum Artikel im Literaturverzeichnis.");
...
define("VL_EDT_DESC_CHAPTER","Ausgewählte Kapitel im Literaturverzeichnis, wenn überhaupt");
define("VL_EDT_DESC_CHECKEDOUT","Artikel ist in Joomla ausgechecked");
define("VL_EDT_DESC_CITE","Deine eigene Abkürzung für diese Publikation. Wenn nicht besorgt, wird die nächste ganzzahlige Nummer für Dich gegeneriert.");
...
define("VL_EDT_DESC_EPRINT","Relative oder absolute URL-Adresse wo eine Kopie dieses eBuchs gefinden werden kann.");
define("VL_EDT_DESC_HOWPUBLISHED","Kurze Bezeichnung wie die Publikation veröffentlicht worden ist, wenn es auf ungewöhnlicher Weise war");
...
define("VL_EDT_DESC_INSTITUTION","Das Institut das mit dem erstellen verbunden war, aber nicht unbedingt das Verlag");
...
define("VL_EDT_DESC_KEYWORDS","Stichwörter die beim durchsuchen der Publikationen hilfen werden");
define("VL_EDT_DESC_LOCID","Lokations-Id des fassbaren Buches");
define("VL_EDT_DESC_MONTH","Der Monat in dem es veröffentlicht würde");
define("VL_EDT_DESC_NOTE","Deine eigene Notizen");
...
define("VL_EDT_DESC_ORGANIZATION","Organisation die die Publikation unterstützt / befürwortet.");
define("VL_EDT_DESC_PAGES","Seitenzahl der Publikation");
define("VL_EDT_DESC_PUBLISHED","Dieser Artikel ist veröffentlicht, d.h. Besucher werden es in Deine Virtuelle Bibliothek sehen können. Wenn Du es aber noch am editieren bist order es nicht veröffentlichen möchtest, stell dieses nach Unveröffentlicht");
...
define("VL_EDT_DESC_SHORTAUTHNAMES","Beliebige Abkürzung von alle Autornamen wenn es sämmtliche Autoren gibt. Sonnst wird der erste Autorname gebraucht und wird ein 'et al' beigefügt, in dessen Fall es wichtig ist dass der wichtigste Autor auch der erste Autor ist den Du einträgst.");
define("VL_EDT_DESC_TITLE","Titel wie es in der Publikation erscheint. Du sollst es nich verkürzen!");
...
define("VL_EDT_DESC_VIEWED","Anzahl Besichtigungen");
define("VL_EDT_DESC_VOLUME","Bandname falls es ein Multiband-Buch ist");
define("VL_EDT_DESC_YEAR","Das Jahr in dem es veröffentlicht würde");

define("VL_EDT_DESC_FIRST","Autor/ins Vorname");
define("VL_EDT_DESC_VON","Familiennamenpäfix wie 'von' in 'von M&uuml;nchausen' oder 'van' wie in 'van Halen'");
define("VL_EDT_DESC_LAST","Autor/ins Familienname / Letztername");
define("VL_EDT_DESC_JR","Altmodischer Familiennamensuffix wie zB. 'Jr.', 'Sr.' or 'Esq.'");

define("VL_EDT_DESC_CAT","Wähle die Fachkategorie die Du an der Publikation anweisen möchtest. Du kannst mehr als eine Kategorie wählen wenn Du die Steuerungstaste (Strg) währent der Wahl herabdrückst.");
...
define("VL_CNF_NAME_COL_AUTHORS","Autoren oder Redakteuren");
...
define("VL_CNF_NAME_COL_PUBDATE","Veröffenlichungsjahr und Monat");
...
define("VL_CNF_DESC_SMALLICONS","Zeig kleine, statt grosse Ikonen für Hypertext-Links");
define("VL_CNF_DESC_SQUEEZE","Verkurze Titeln, Autornamen usw. damit jede Publikation in nur eine Zeile in der Tabelle gezeigt wird");
...
define("VL_BIBTEX_FILE_CHOOSE_DESC","Wähle eine Datei mit eine .bib-Erweiterung von Deinem Rechner und klick den Upload-Knopf.");
define("VL_CONFIGURATION","Konfiguration");
define("VL_COPYPASTE_BIBTEX","Copy&amp;Paste BibTeX input");
define("VL_PASTE_BIBTEX_STRING","Paste BibTeX Zeichenkette");
...
define("VL_PUBLICATION_DETAILS_DESC","Nur der Titel ist erforderlich, aber wenn man eine schöne Virtuelle Bibliothek haben möchte, dann sollte man die anderen Feldern auch eintragen.");
...
define("VL_TOOLBAR_PASTE_BIBTEX_STRING","Paste BibTeX Zeichenkette");
